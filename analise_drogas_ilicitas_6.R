...
tg <- textGrob('Tailândia', gp = gpar(fontsize = 13, fontface = 'bold'))

plot_tailandia <- grid.arrange(g1, g2, g3, g4, ncol = 2,  # ncol se refere a número de colunas
                    top = tg)

# Salvar gráfico ---------------------------------------------------------------------------------------------------------------------------

ggsave("plot_tailandia.pdf", plot_tailandia, width = 15, height = 15)
